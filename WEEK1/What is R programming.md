...
R is specialized; it doesn't build apps, but if your entire goal is to clean a messy spreadsheet, run a statistical analysis, and plot a beautiful graph, R is built exactly for that purpose. \
